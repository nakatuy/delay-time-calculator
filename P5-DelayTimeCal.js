...
function draw() {
  ...
  }else if (currentTime-pushtime > fadetime && currentTime-pushtime < fadetime*2){
    fade = 255 - ((currentTime-pushtime-fadetime) / fadetime * 255);
    shrink = fade / 255;
    stroke(color_2, color_3, color_1, fade);
    ellipse(position_X2,position_Y2,ellipse_radius*0.85*shrink);
  }else if (currentTime-pushtime > fadetime*2 && currentTime-pushtime < fadetime*3){
    fade = 255 - ((currentTime-pushtime-fadetime*2) / fadetime * 255);
    shrink = fade / 255;
    stroke(color_3, color_1, color_2, fade);
    ellipse(position_X3,position_Y3,ellipse_radius*0.7*shrink);
  }else if (currentTime-pushtime > fadetime*3 && currentTime-pushtime < fadetime*4){
    fade = 255 - ((currentTime-pushtime-fadetime*3) / fadetime * 255);
    shrink = fade / 255;
    stroke(color_3, color_2, color_1, fade);
    ellipse(position_X4,position_Y4,ellipse_radius*0.55*shrink);
  }else if (currentTime-pushtime > fadetime*4 && currentTime-pushtime < fadetime*5){
    fade = 255 - ((currentTime-pushtime-fadetime*4) / fadetime * 255);
    shrink = fade / 255;
    stroke(color_2, color_1, color_3, fade);
    ellipse(position_X5,position_Y5,ellipse_radius*0.4*shrink);
  }else if (currentTime-pushtime > fadetime*5 && currentTime-pushtime < fadetime*6){
    fade = 255 - ((currentTime-pushtime-fadetime*5) / fadetime * 255);
    shrink = fade / 255;
